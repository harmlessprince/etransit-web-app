...
use App\Http\Controllers\Eticket\TrackingConsole;
...
use App\Http\Controllers\ServiceManagent;
...
//partner page
Route::get('partners', [Partner::class, 'partnerPage']);
Route::get('partners/driver', [Partner::class, 'driverPartnerPage']);
Route::get('partners/drivers/', [Partner::class, 'driverPartnerPage']);
Route::post('store/become-partners', [Partner::class, 'becomePartners']);
Route::post('partners/driver/register', [Partner::class, 'registerDriverApplication']);
Route::get('/admin/export-transaction', [Transaction::class, 'exportCsv']);

//NYSC page
Route::get('nysc', [Vehicle::class, 'NyscHome']);
...
//        Route::get('/export-transaction', [Transaction::class , 'exportCsv']);
        ...
        Route::get('delete-operator/{id}', [Operator::class, 'deleteOperator']);
        ...
        //all become partners
        Route::get('/all-partners', [Partner::class, 'partners']);
        Route::get('fetch-all-become-partners', [Partner::class, 'fetchBecomePartners'])->name('fetch-all-become-partners');
        Route::get('view-partners/{partner_id}', [Partner::class, 'viewPartner']);
        Route::get('enable-partner-as-operator/{partner_id}', [Partner::class, 'enablePartnerAsOperator']);

        //partner drivers
        Route::get('/all-partner-drivers', [Partner::class, 'newDrivers']);
        Route::get('fetch-all-driver-applications', [Partner::class, 'fetchDriverApplications'])->name('fetch-driver-applications');
        Route::get('/view-partner/driver/{partner_drver_id}', [Partner::class, 'viewDriver']);
        Route::get('/partner/approve-driver/{partner_driver_id}', [Partner::class, 'approveDriverApplication']);

        //switch service on or off
        Route::get('all-services', [ServiceManagent::class, 'allServices']);
        Route::post('activate-deactivate-service', [ServiceManagent::class, 'activateOrDeactivateService']);
...
//    Route::post('/user',[AuthLogin::class,'fetchUser'])->name('user');
    ...
    Route::get('/add-schedule', [ManageBus::class, 'addScheduleView'])->name('add-schedule-view');
    Route::post('/add-schedule', [ManageBus::class, 'postScheduleView'])->name('post-schedule-view');
...
//        ->name('add-eticket-schedule');
        ...
        //tracking console
        Route::get('all/tracking', [TrackingConsole::class, 'allTracking']);
        Route::get('view-tracking/{tracking_id}', [TrackingConsole::class, 'viewEachTracking']);
