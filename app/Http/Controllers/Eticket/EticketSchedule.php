...
//        return response()->json(['message' => 'uploaded successfully'], 200);
    ...
    {
        $findSchedule = EventSchedule::where('tenant_id', session()->get('tenant_id'))->get();
        ...
        $emptySeatSchedules = EventSchedule::with(['pickup', 'destination', 'bus', 'terminal'])
            ->where('tenant_id', session()->get('tenant_id'))
            ->whereIn('id', $emptySeatScheduleId)
            ->paginate(20);
