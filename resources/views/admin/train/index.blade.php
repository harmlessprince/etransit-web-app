            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Train Management</li>
                    </ol>
                </div>
            </div>
        </div>
...
{{--                <a href="{{url('/admin/import-export-cars')}}" class="btn bulk-upload-button btn-sm"  style="margin-right:10px;">Bulk Import Boat</a>&nbsp;--}}
                ...
                <a href="{{url('admin/add/train')}}">
                    <button class="btn s add-terminal-button btn-sm">Add Train</button>
                </a>
                        ...
                        @foreach($trains as $train)
                            <div class="card text-white terminal-card mb-3" style="max-width: 18rem;">
                                <div class="card-body" style="display: flex;justify-content: center;">
                                    <small class="card-title"> {{strtoupper($train->name)}}</small>
                                </div>
                                <div class="card-footer terminal-card" style="display: flex;justify-content: center;">
                                    <a href="{{url('/admin/train/'.$train->id.'/history')}}" class="btn schedule-button">View</a>
                                    <a href="{{url('/admin/manage/train/schedule/'.$train->id)}}" class="btn schedule-button">Schedule </a>
                                </div>
