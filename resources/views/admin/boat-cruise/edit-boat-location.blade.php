...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Update Boat Location</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update_boat_location/'.$boatLocation->id)}}" >
                    @csrf
                    @method('PUT')
                    <div class="car-box">
                        <div class="form-group">
                            <label for="boat_location">Boat Location</label>
                            <input type="text" class="form-control" name="boat_location" id="boat_location" value="{{ $boatLocation->destination  }}"  required/>
                        </div>
                    </div>
