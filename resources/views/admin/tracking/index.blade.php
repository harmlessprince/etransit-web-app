            ...
            <div class="card-body">
                <form action="{{url('admin/all/tracking')}}">
                    ...
                    <div style="display: flex;justify-content: center;">
                        ...
                        &nbsp;&nbsp;
                        <a class="btn btn-danger btn-sm" href="{{url('admin/all/tracking')}}" style="color:white;">Reset
                            Filter</a>
                    </div>
                </form>
            </div>
                ...
                @foreach($trackers as $tracker)
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p><a href="{{url('admin/view-tracking/'.$tracker->id)}}" class="btn btn-success btn-sm">View
