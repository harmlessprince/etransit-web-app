...
@section('content')
                        ...
                        <div class="form-group">
                            @foreach($services as $index => $service)
                                ...
                                <div class="switch_box">
                                    <div>
                                        <label class="switch">
                                            <input type="checkbox" class="services" value="{{$service->id}}"  @if( $service->status == 'active' ) checked  @endif>
    ...
    <script type="text/javascript">
        ...
        $(".services").change(function(e){
            ...
            $.ajax({
                type:'POST',
                url: "/admin/activate-deactivate-service",
                data:{"_token": "{{ csrf_token() }}",serviceId , checked},
