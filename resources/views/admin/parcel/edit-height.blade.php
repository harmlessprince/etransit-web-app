...
{{--                </div>--}}
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update-height/'.$height->id.'/parcel')}}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}

                    <div class="car-box col-md-12">
                        <div class="form-group">
                            <label for="boat_name">Min Height</label>
                            <input class="form-control" name="min_height"  type="text" value="{{$height->min_height}}">
                        </div>
                    </div>
                    <div class="car-box col-md-12">
                        <div class="form-group">
                            <label for="boat_name">Max Height</label>
                            <input class="form-control" name="max_height"  type="text" value="{{$height->max_height}}">
                        </div>
                    </div>
                    <div class="car-box col-md-12">
                    <div class="form-group">
                        <label for="amount">Amount</label>
                        <input type="text" name="amount" id="amount" class="form-control" value="{{ $height->amount }}" required />
                    </div>
                    </div>
