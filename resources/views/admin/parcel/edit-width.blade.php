            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Edit Width</li>
                    </ol>
                </div>
{{--                <div class="col-6">--}}
{{--                    <!-- Bookmark Start-->--}}
...
{{--                </div>--}}
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update-width/'.$width->id.'/parcel')}}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="car-box col-md-12">
                        <div class="form-group">
                            <label for="boat_name">Min Width</label>
                            <input class="form-control" name="min_width"  type="text" value="{{$width->min_width}}">
                        </div>
                    </div>
                    <div class="car-box col-md-12">
                        <div class="form-group">
                            <label for="boat_name">Max Length</label>
                            <input class="form-control" name="max_width"  type="text" value="{{$width->max_width}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="amount" id="amount" class="form-control" value="{{ $width->amount }}" required />
                    </div>
                    </div>
