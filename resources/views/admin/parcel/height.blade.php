...
{{--                <button class="btn s add-terminal-button btn-sm" >Bulk Upload</button>--}}
                <button class="btn s add-terminal-button btn-sm"  data-toggle="modal" data-target="#vehicleModal">Add Height</button>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <div >
                    @if(count($heights) > 0)
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col">Min(cm)</th>
                                <th scope="col">Max(cm)</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel" >Dimension Chart (Height)</h2>
                ...
                <form >
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="min_height" id="min_height" />
                        </div>
                        <div class="form-group">
                            <label for="max_height">Maximum Height (CM) </label>
                            <input type="number" class="form-control" name="max_height" id="max_height" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="send-btn  btn-submit" id="send-btn">Add Height</button>
                    </div>
                </form>
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e){
            e.preventDefault();
            var max     = $('#max_height').val();
            var min     = $('#min_height').val();
            ...
            $.ajax({
                type:'POST',
                url: "/admin/add/dimension/height",
