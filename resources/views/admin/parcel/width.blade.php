            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Add Width</li>
                    </ol>
                </div>
            </div>
        </div>
...
{{--                <button class="btn s add-terminal-button btn-sm" >Bulk Upload</button>--}}
                <button class="btn s add-terminal-button btn-sm"  data-toggle="modal" data-target="#vehicleModal">Add Width</button>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="exampleModalLabel" >Dimension Chart (Width)</h2>
                ...
                <form >
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="min_width">Minimum Width (cm)</label>
                            <input type="number" class="form-control" name="min_width" id="min_width" />
                        </div>
                        <div class="form-group">
                            <label for="max_width">Maximum Width (cm) </label>
                            <input type="number" class="form-control" name="max_width" id="max_width" />
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="send-btn  btn-submit" id="send-btn">Add Width</button>
                    </div>
                </form>
    ...
    <script type="text/javascript">
        ...
        $(".btn-submit").click(function(e){
            e.preventDefault();
            var max     = $('#max_width').val();
            var min     = $('#min_width').val();
