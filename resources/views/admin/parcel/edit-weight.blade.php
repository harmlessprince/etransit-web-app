            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Edit Weight</li>
                    </ol>
                </div>
{{--                <div class="col-6">--}}
{{--                    <!-- Bookmark Start-->--}}
...
{{--                </div>--}}
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update-weight/'.$weight->id.'/parcel')}}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="car-box col-md-12">
                        <div class="form-group">
                         <label for="boat_name">Min Weight</label>
                          <input class="form-control" name="min_weight"  type="text" value="{{$weight->min_weight}}">
                        </div>
                    </div>
                    <div class="car-box col-md-12">
                        <div class="form-group">
                            <label for="boat_name">Max Weight</label>
                            <input class="form-control" name="max_weight"  type="text" value="{{$weight->max_weight}}">
                        </div>
                    </div>
                    <div class="car-box col-md-12">
                    <div class="form-group">
                        <label for="amount">Amount</label>
                        <input type="text" name="amount" id="amount" class="form-control" value="{{ $weight->amount }}" required />
                    </div>
                    </div>
