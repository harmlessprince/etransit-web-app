...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Update car</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update_car_class/'.$carClassEdit->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="car-box">
                        <div class="form-group">
                            <label for="car_class">Car Class</label>
                            <input type="text" class="form-control" name="car_class" id="car_class" value="{{ $carClassEdit->name  }}"  required/>
                        </div>
                    </div>
