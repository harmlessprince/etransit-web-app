...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Update Car Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update_car_type/'.$carTypeEdit->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="car-box">
                        <div class="form-group">
                            <label for="car_type">Car Class</label>
                            <input type="text" class="form-control" name="car_type" id="car_type" value="{{ $carTypeEdit->name  }}"  required/>
                        </div>
                    </div>
