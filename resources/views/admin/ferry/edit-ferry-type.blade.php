...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Update Ferry Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/admin/update_ferry_type/'.$ferryType->id)}}" >
                    @csrf
                    @method('PUT')
                    <div class="car-box">
                        <div class="form-group">
                            <label for="ferry_type">Ferry Types</label>
                            <input type="text" class="form-control" name="ferry_type" id="ferry_type" value="{{ $ferryType->name  }}"  required/>
                        </div>
                    </div>
