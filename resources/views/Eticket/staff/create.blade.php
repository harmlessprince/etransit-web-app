                    ...
                    <div class="card-body">
                        <form action="{{url('e-ticket/store-staff')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="address" value="{{old('address')}}" id="designation"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="employment_date" value="{{old('employment_date')}}" id="employment_date"/>
                            </div>
