                        ...
                        <form action="{{url('e-ticket/update-tenant-terminal/'.$terminal->id)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="terminal_name"
                                       value="{{$terminal->terminal_name}}" id="terminal_name"/>
                            </div>
                            <div class="form-group">
                                <label for="terminal_address">Terminal Address</label>
                                <input type="text" class="form-control" name="terminal_address"
                                       value="{{$terminal->terminal_address}}" id="terminal_address"/>
                            </div>
                            <div class="form-group">
                                <label for="location">Location(s)</label>
                                <select name="location" class="form-control">
                                    <option
                                        value="{{$terminal->destination->id}}">{{$terminal->destination->location}}</option>
