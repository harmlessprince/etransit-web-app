...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Edit Tour</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/e-ticket/update-tour/'.$tour->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="10" cols="20" required >{{$tour->description}}</textarea>
                    </div>
