...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-12 col-xl-12 col-lg-12 col-sm-12">
                <div class="add_bus_btn">
                    <div class="space-left">
                        <a href="{{url('e-ticket/edit-car-plan/'.$editCar->id)}}" class="btn btn-success">Update Car
                            Plans</a>
                    </div>
                    <div class="space-left">
                        <a href="{{url('e-ticket/update-car-image/'.$editCar->id)}}" class="btn btn-success">Update Car
                            Images</a>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/e-ticket/update-tenant-car/'.$editCar->id)}}"
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="car_brand" id="car_brand" class="form-control"
                                           value="{{ $editCar->car_name}}" required/>
                                </div>
                            </div>
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="car_registration"
                                           id="car_registration" value="{{ $editCar->car_registration }}" required/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="capacity" id="capacity"
                                           value="{{ $editCar->capacity }}" required/>
                                </div>
                            </div>
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="transmission" id="transmission">
                                        <option
                                            value="{{$editCar->transmission}}">{{Ucfirst($editCar->transmission)}}</option>
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="model_year" id="model_year"
                                           value="{{ $editCar->model_year }}" required/>
                                </div>
                            </div>
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="self_drive" id="self_drive"
                                           @if($editCar->self_drive == 'active') checked @endif>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="ckeditor form-control" name="description" id="description" rows="10"
                                      cols="20" required>{{ $editCar->description }}</textarea>
                        </div>
