...
@section('content')
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/e-ticket/update-car-plan/'.$carId)}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="car-box">
                        <div class="row">
                            ...
                            <div class="col-md-12 colm-sm-12 col-lg-12 col-xl-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="{{$plan->plan}}" id="plan" class="form-control" value="{{ $plan->amount }}"  required/>
                                </div>
                            </div>
                            @endforeach
                          </div>
