            ...
            <div class="card-body">
                <form method="post" action="{{url('/e-ticket/store-car')}}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="car_brand" id="car_brand" class="form-control"
                                           value="{{ old('car_brand') }}" placeholder="e.g Toyota Corolla" required/>
                                </div>
                            </div>
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    <label for="car_registration">Car Registration</label>
                                    <input type="text" class="form-control" name="car_registration"
                                           id="car_registration" value="{{ old('car_registration') }}" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="model_year" id="model_year"
                                           value="{{ old('model_year') }}" placeholder="2009" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="daily_rentals" id="daily_rentals"
                                           value="{{ old('daily_rentals') }}" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="sw_region_fare" id="sw_region_fare"
                                           value="{{ old('sw_region_fare') }}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="se_region_fare" id="se_region_fare"
                                           value="{{ old('se_region_fare') }}"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ss_region_fare" id="ss_region_fare"
                                           value="{{ old('ss_region_fare') }}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nc_region_fare" id="nc_region_fare"
                                           value="{{ old('nc_region_fare') }}"/>
                                </div>
                            </div>
                            <div class="col-md-6 colm-sm-6 col-lg-6 col-xl-6 col-xs-6">
                                <div class="form-group">
                    ...
                    <div class="file_image_form row">
                        ...
                        <div class="col-md-6 col-sm-6 col-sm-6 col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="file" id="images" class="form-control image_file" name="images[]"
                                       multiple="multiple" required>
                            </div>
                        </div>

                        <div class="add_button">
                            <button id="buttonID"><img src="{{asset('images/icons/upload.png')}}" width="20"
                                                       height="20"/></button>
                            <br>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="ckeditor form-control" name="description" id="description" rows="10" cols="20"
