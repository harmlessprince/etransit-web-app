...
@section('content')
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Update Car Image</li>
                    </ol>
                </div>
                {{--                <div class="col-6">--}}
                {{--                    <!-- Bookmark Start-->--}}
    ...
    <div class="container-fluid" >
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{url('/e-ticket/update/'.$car_id.'/car-image')}}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    ...
                    @endif
                    <button class="sumbit_request" type="submit">Update Car Image</button>
                </form>
            </div>
