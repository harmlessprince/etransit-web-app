                ...
                <div class="vehicle-box">
                        ...
                        @foreach($boats as $boat)
                            <div class="card terminal-card mb-3 card_div" style="max-width: 18rem;">
                                ...
                                <div class="card-footer terminal-card" style="display: flex;justify-content: center;">
                                    ...
                                    <a href="{{url('/e-ticket/view-boat/'.$boat->id)}}"
                                       class="btn schedule-button">View</a>
                                    {{--                                    <a href="{{url('/admin/edit/'.$boat->id . '/boat')}}" class="btn schedule-button">Update</a>--}}
                                    <a href="{{url('/e-ticket/schedule-boat-trip/'.$boat->id)}}"
                                       class="btn schedule-button">Schedule</a>
                                </div>
                    ...
                    @else
                        <div class="no_data_img">
                            <div class="not_found">
                                <div>
                                    <img src="{{asset('images/illustrations/empty_data.png')}}" width="400" height="300"
                                         alt="bus-image"/>
                                </div>
                            </div>
                        </div>
