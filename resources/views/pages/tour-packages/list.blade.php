        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-3 flex-grow-0 flex-shrink-1 flex-wrap"
                     style="box-shadow: 1px 1px 6px 1px rgb(189,189,190);padding-top: 15px;padding-bottom: 15px;border-radius: 9px;min-height: auto;max-height: 600px;">
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row" style="margin-bottom: 11px;">
                        <div class="col">
                            <p style="margin-top: 4px;margin-bottom: 0;font-size: 13px;cursor: pointer;"
                               onclick="collapse('tour-types')"><strong>Tour Type</strong></p>
                        </div>
                    </div>
                    <hr>
                    <form method="GET" action="{{url('tour-packages')}}">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                                           id="formCheck-8">
                                                <input class="form-check-input" type="checkbox" name="tour_types[]"
                                                       value="{{$type}}" id="formCheck-2">
                                            </div>
                                        </td>
                        ...
                        <div class="row" style="margin-bottom: 11px;">
                            <div class="col">
                                <p style="margin-top: 4px;margin-bottom: 0;font-size: 13px;cursor: pointer;"
                                   onclick="collapse('tour-dates')"><strong>Tour Dates</strong></p>
                            </div>
                        </div>
                        <hr>
                                ...
                                @foreach($tours as $tour)
                                    <tr>
                                        <td>
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                                           id="formCheck-8">
                                                <input class="form-check-input" type="checkbox" name="tour_dates[]"
                                                       value="{{$tour->tour_date}}" id="formCheck-2">
                                            </div>
                                        </td>
                ...
                <div class="col-sm-6 col-md-9" id="cruisedisplay">
                    <div class="row" style="padding-left: 0;padding-right: 0;margin-top: 15px;margin-bottom: 15px;">
                        <h5 id="mddisplay">Available Package&nbsp;</h5>
                        <div class="col">
                            <div
                                class="row text-start d-md-flex justify-content-start align-content-start justify-content-md-start"
                                style="margin-right: 0;margin-left: 0;">
                                <div class="col-md-10 offset-md-1" style="padding-right: 0;padding-left: 0;">
                                    <div class="card m-auto" style="max-width:850px">
                                        <div
                                            class="card-body text-start placeholder border rounded-0 d-md-flex align-items-start align-content-start search-container"
                                            style="height: 40px;padding-top: 5px;background: var(--bs-gray-100);border-radius: 7px;">
                                            <form class="d-flex align-items-center">
                                                <i class="fas fa-search d-none d-sm-block h4 text-body m-0"
                                                   style="font-size: 15.704px;"></i>
                                                <input
                                                    class="form-control form-control-lg flex-shrink-1 form-control-borderless search-container"
                                                    id="search" type="search" placeholder="Search Tour" name="searchbar"
                                                    style="height: 29px;padding-top: 0;padding-bottom: 1px;min-height: 29px;font-size: 14px;background: var(--bs-gray-100);">
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        @foreach($tours as $index => $tour)
                            <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-6" id="cruisedisplay-1"
                                 style="margin-left: 0;">
                                <a class="anchor" href="{{url('/tour-packages/'.$tour->id.'/show')}}">
                                    <div class="card-group">
                                        <div class="card"
                                             style="margin: 10px;border-radius: 10px;margin-right: 10px;border-style: none;box-shadow: 1px 1px 10px 1px rgb(204,205,205);">
                                            <img class="img-fluid card-img-top w-100 d-block"
                                                 style="border-top-left-radius: 7px;border-top-right-radius: 7px;"
                                                 src="{{$tour->tourimages[0]->path}}">
                                            ...
                                            <div class="card-body" style="padding-top: 0;">
                                                ...
                                                <p style="color: rgb(175,175,176);font-size: 14px;"> {!! Str::limit($tour->description, $limit = 150, $end = '...') !!}  </p>
                                            </div>
                                            <div class="align-items-center align-content-center card-footer">
                                                <ul class="list-unstyled text-center d-md-inline-flex m-auto d-md-inline in"
                                                    id="rating-1" display="inline-block" gap="20px">
                                                    <li style="font-size: 14px;color: #afafb0;"><i class="fa fa-star"
                                                                                                   style="color: var(--bs-yellow);"></i>&nbsp;4.7/5
                                                        Ratings&nbsp; &nbsp; &nbsp; &nbsp;
                                                    </li>
                                                    <li class="justify-content-end"
                                                        style="font-size: 14px;color: #afafb0;"><i
                                                            class="icon ion-location"
                                                            style="color: var(--bs-orange);"></i>&nbsp;{{$tour->location}}
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
