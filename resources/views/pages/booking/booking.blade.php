...
{{--                            <td>55</td>--}}
                        ...
                        <input type="hidden" name="departure_date" value="{{$checkSchedule[0]->departure_date->format('Y-m-d') ?? now()->format('Y-m-d')}}"/>
                        <input type="hidden" name="return_date" value="{{$checkSchedule[0]->return_date->format('Y-m-d') ?? now()->format('Y-m-d')}}"/>
                        <input type="hidden" name="destination_from" value="{{$checkSchedule[0]->destination->id }}"/>
                        <input type="hidden" name="destination_to" value="{{$checkSchedule[0]->pickup->id }}"/>
