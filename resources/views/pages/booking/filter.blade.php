            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 flex-grow-0 flex-shrink-1 flex-wrap" style="box-shadow: 1px 1px 6px 1px rgb(228,228,230);padding-top: 15px;padding-bottom: 15px;border-radius: 9px;min-height: 500px;max-height: 900px;margin-bottom: 10px;height: 850px;background: #ffffff;">
                    ...
                    <form action="{{url('/bus/filter-bookings')}}" method="POST">
                                                    ...
                                                    <td>
                                                        <div class="form-check">
                                                            <input class="bus_operator_input form-check-input"
                                                                   ...
                                                                   type="checkbox"
                                                                   id="formCheck-8">
                                                            <label class="form-check-label" for="formCheck-8">{{$operator->display_name}}</label>
                                                        </div>
                                                    </td>
                        ...
                        <div class="row">
                            <div class="col">
                                <p style="margin-top: 4px;margin-bottom: 0px;font-size: 13px;"><strong>Bus Type</strong></p>
                            </div>
                            <div class="col" style="text-align: right;">
                                <div class="" style="height: 24px;">
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($busTypes as $type)
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="bus_type[]" value="{{$type->type}}" id="formCheck-2">
                                                <label class="form-check-label" for="formCheck-2" style="color: #afafb0;">{{$type->type}}</label>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="col-sm-6 col-md-9" id="cruisedisplay" style="padding-left: 0px;padding-right: 0px;">
                    <div class="row" id="optionline-1" style="padding-left: 0px;padding-right: 0px;margin-top: 0px;margin-bottom: 15px;margin-left: 10px;margin-right: 0px;background: var(--bs-gray-200);">
                        <div class="col" style="background: var(--bs-gray-200);border-right: 1px none #bebebe;">
                            <div class="" id="targetcenter-1" style="border-style: none;background: rgba(238,238,238,0);"><button class="btn btn-primary " aria-expanded="false" data-bs-toggle="" type="button" style="color: rgb(136,136,136);background: rgba(238,238,238,0);border-style: none;">&nbsp;From</button>
                        ...
                        <div class="col d-lg-flex justify-content-lg-center align-items-lg-center" style="background: var(--bs-gray-200);">
                            <p style="color: rgb(121,122,122);text-align: center;"><svg xmlns="https://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="font-size: 33px;">
                        ...
                        <div class="col" style="background: var(--bs-gray-200);border-right: 1px solid #bebebe;">
                            <div class="" style="border-style: none;background: rgba(238,238,238,0);"><button class="btn btn-primary" aria-expanded="false" data-bs-toggle="" type="button" style="color: rgb(136,136,136);background: rgba(238,238,238,0);border-style: none;">To&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</button>
                                <!-- <div class="dropdown-menu"><a class="dropdown-item" href="#">First Item</a><a class="dropdown-item" href="#">Second Item</a><a class="dropdown-item" href="#">Third Item</a></div> -->
                            </div>
                        ...
                        <div class="col" style="background: var(--bs-gray-200);">
                            <div class="" style="border-style: none;background: rgba(238,238,238,0);"><button class="btn btn-primary" aria-expanded="false" data-bs-toggle="" type="button" style="color: rgb(136,136,136);background: rgba(238,238,238,0);border-style: none;">Departure&nbsp;&nbsp;</button>
                                <!-- <div class="dropdown-menu"><a class="dropdown-item" href="#">First Item</a><a class="dropdown-item" href="#">Second Item</a><a class="dropdown-item" href="#">Third Item</a></div> -->
                            </div>
                        ...
                        <div class="col mx-auto" style="background: var(--bs-gray-200);">
                            ...
                            <p style="font-weight: bold;text-align: left;margin-bottom: 0px; text-align: center;">&nbsp; &nbsp;1 Adult</p>
                                    ...
                                    <div class="row" style="border-radius: 7px;box-shadow: 2px 1px 5px 1px rgb(226,226,227);padding: 17px;background: #ffffff;">
                                        ...
                                        <div class="col align-self-center">
                                            ...
                                            <p class="text-start" style="font-size: 17px;">
                                                <span>{{$schedule->pickup->location}} </span><span>&nbsp;&nbsp;<svg xmlns="https://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-arrow-right">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="text-start" style="font-size: 17px;"><span>&nbsp;<svg xmlns="https://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-clock-fill">
