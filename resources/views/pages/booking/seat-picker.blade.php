                        ...
                        <div class="row passenegr_header">
                            <div class="col">
                                <h5>PASSANGER DETAILS
                                    <div class="add_more_passeneger_icon">
                                        <button id="buttonID"><img src="{{asset('images/icons/add_user_2.png')}}"
                                                                   width="20" height="20"/> Add More Passenger
                                        </button>
                                    </div>
                                </h5>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col" style="margin-top: 28px;">
                                            <label class="form-label"
                                                   style="font-size: 14px;color: var(--bs-gray-500);">FULL NAME</label>
                                            <input class="form-control" name="full_name[]" type="text"
                                                   ...
                                                   value="{{auth()->user()->full_name}}" required></div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <label class="form-label"
                                                   style="font-size: 14px;color: var(--bs-gray-500);">GENDER</label>
                                        ...
                                        <div class="form-group passenger_name">
                                            <div><label class="form-label"
                                                        style="font-size: 14px; margin-top:15px;color: var(--bs-gray-500);">NEXT
                                                    OF KIN FULL NAME</label></div>
                                            <div><input type="text" name="next_of_kin_name[]" class="form-control"
                                                        type="text"
                                                        style="border-top-style: none;border-right-style: none;border-left-style: none;border-radius: 0px;border-top-left-radius: 0px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;border-bottom-left-radius: 1px;background: rgba(255,255,255,0);"/>
                                            </div>
                                        </div>
                                        <div class="form-group passenger_name">
                                            <div><label class="form-label"
                                                        style="font-size: 14px;margin-top:15px;color:  var(--bs-gray-500);">NEXT
                                                    OF KIN NUMBER</label></div>
                                            <div><input type="text" name="next_of_kin_number[]" class="form-control"
                                                        type="text"
                                                        style="border-top-style: none;border-right-style: none;border-left-style: none;border-radius: 0px;border-top-left-radius: 0px;border-top-right-radius: 0px;border-bottom-right-radius: 0px;border-bottom-left-radius: 1px;background: rgba(255,255,255,0);"/>
                                            </div>
                                        </div>
...
{{--                    </div>--}}
                ...
                <div class="row">
                    <div
                        class="col-12 d-md-flex justify-content-center align-items-center align-content-center align-self-center justify-content-md-center"
                        style="text-align: center;margin-top: 14px;padding-bottom: 17px;">
                        <button class="btn btn-primary" type="submit"
                                style="width: 235.422px;background: rgb(52,63,95);">CONTINUE TO PAYMENT
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $(".seat_selector").click(function (e) {
            ...
            var user_id = {{auth()->user()->id}}
                var
            trip_type = $("input[name='tripType']").val();
