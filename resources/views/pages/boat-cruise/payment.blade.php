                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col" style="text-align: left;"><span class="d-block"
                                    ...
                                    <strong>{{$trip->cruise_name}}</strong>
                                </span>
                                    <span class="d-block"
                                          style="color: var(--bs-gray);font-size: 14px;">{{$type}} Type</span></div>
                            </div>
                        </div>
                        ...
                        <div class="col-12"
                            ...
                            <div class="table-responsive fs-6"
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td style="color: var(--bs-gray-600);font-size: 12px;text-align: left;">{{ $trip->departure_date->format('d M Y')}}</td>
                                        <td style="color: var(--bs-gray-600);font-size: 12px;">{{ $trip->departure_time->format('H:i:s')}}</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12px;color: var(--bs-gray-600);text-align: left;"><strong>Type</strong>
                                        </td>
