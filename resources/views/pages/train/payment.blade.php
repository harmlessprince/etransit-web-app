...
{{--                                    <span class="d-block" style="color: var(--bs-gray);font-size: 14px;">{{$fetchScheduleDetails->bus->car_type}}</span>--}}
                        ...
                        <div class="col-12" style="padding-left: 0px;">
                            <ul class="timeline" style="border-color: rgb(248,161,89);margin-left: -4.7031px;">
                                <li class="from">
                                    ...
                                    <span class="d-block" style="margin-bottom: 3px;text-align: left;">{{$fetchScheduleDetails->pickup->locations_state}}</span>
                        ...
                        <div class="col-12" style="border-top-left-radius: 16px;border-top-right-radius: 20px;background: var(--bs-white);box-shadow: 1px 0px 8px rgb(227,227,228);">
                            <div class="table-responsive fs-6" style="font-size: 14px;border-bottom-width: 1px;border-bottom-style: dashed;">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <td style="font-size: 12px;color: var(--bs-gray-600);text-align: left;"><strong>PickUp Terminal</strong></td>
                                        <td style="font-size: 12px;color: var(--bs-gray-600);"><strong>DropOff Terminal</strong></td>
                                    </tr>
                                    <tr>
                                        <td style="color: var(--bs-gray-600);font-size: 12px;text-align: left;">
                                    ...
                                    <tr>
                                        <td style="font-size: 12px;color: var(--bs-gray-600);text-align: left;"><strong>Number Of Ticket(s)</strong></td>
                                        <td style="font-size: 12px;color: var(--bs-gray-600);"><strong>Class Type</strong></td>
                                    </tr>
                                    <tr>
                                        <td style="color: var(--bs-gray-600);font-size: 12px;text-align: left;">
                                    ...
                                    <tr>
                                        @if($adultCount > 0)
                                            ...
                                            <td style="color: var(--bs-gray-600);font-size: 12px;">&#8358; {{number_format($adultFareTotal)}}</td>
                                        @endif
                                    </tr>
                                    <tr>
                                        @if($childrenCount > 0)
                                            <td style="color: var(--bs-gray-600);font-size: 12px;text-align: left;">{{$childrenCount}} Child(ren)</td>
                                            <td style="color: var(--bs-gray-600);font-size: 12px;">&#8358; {{number_format($childFareTotal)}}</td>
                                        @endif
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-6" style="padding-right: 0px;border-bottom-width: 1px;border-bottom-style: none;background: var(--bs-white);">
                            <h6 style="border-bottom-width: 1px;border-bottom-style: dashed;padding-top: 10px;padding-bottom: 10px;color: rgb(52,63,95);"><strong>Total: &#x20A6; {{number_format($amount)}}</strong></h6>
                        </div>
                        <div class="col-6" style="padding-left: 0px;background: var(--bs-white);">
                            <h6 class="text-center" style="border-bottom-width: 1px;border-bottom-style: dashed;padding-top: 10px;padding-bottom: 10px;color: rgb(52,63,95);"><strong>Seat No: @foreach($selectedSeat as $seat) {{Ucfirst($seat->trainseat->coach_type . $seat->trainseat->coach_number)}}, @endforeach</strong></h6>
                        </div>
