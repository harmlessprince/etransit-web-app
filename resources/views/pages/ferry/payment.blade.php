...
@section('content')
                        ...
                        <div class="col-12" style="padding-right: 0px;padding-left: 0px;margin-top: 40px;">
                            ...
                            <div class="payment_button" id="online_payment">
                                <form method="POST" action="{{ route('pay') }}" id="paymentForm">
                                    ...
                                    <input type="hidden" name="service"
                                           value="{{$fetchScheduleDetails->ferry->service->name}}"/>
                                    <input type="hidden" name="service_id"
                                           value="{{$fetchScheduleDetails->ferry->service->id}}"/>
                                    ...
                                    <input type="hidden" name="fetchFerryScheduleDetailsID"
                            ...
                            <div class="payment_button" id="cash_payment_option">
                                <form method="POST" action="{{ url('ferry-cash-payment') }}">
                                    ...
                                    <input type="hidden" name="fetchScheduleDetailsID"
                                           value="{{$fetchScheduleDetails->id}}"/>
                    ...
                    <div class="row"
                        ...
                        <div class="col-12" style="padding-left: 0px;">
                            <ul class="timeline" style="border-color: rgb(248,161,89);margin-left: -4.7031px;">
                                <li class="from">
                                    ...
                                    <span class="d-block"
                                          style="margin-bottom: 3px;text-align: left;">{{$fetchScheduleDetails->pickup->locations}}</span>
                                    <span class="d-block" id="to"
                                          style="font-size: 12px;color: var(--bs-gray-500);margin-top: 4px;">To</span>
                                </li>
                                <li class="to"><span class="d-block"
                                                     style="margin-top: 0px;padding-top: 0px;text-align: left;">{{$fetchScheduleDetails->destination->locations}}&nbsp;</span>
                                </li>
                            </ul>
                        ...
                        <div class="col-12"
                            ...
                            <h6 style="border-bottom-width: 1px;border-bottom-style: dashed;padding-top: 10px;padding-bottom: 10px;color: rgb(52,63,95);">
                                <strong>Total: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &#x20A6; {{number_format($totalFare)}} </strong></h6>
                        </div>
                        <div class="col-12"
                             style="padding-right: 0px;border-bottom-width: 1px;border-bottom-style: none;background: var(--bs-white);">
                            <h6 style="border-bottom-width: 1px;border-bottom-style: dashed;padding-top: 10px;padding-bottom: 10px;color: rgb(52,63,95);">
                                <strong>Seat No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; @foreach($actualSeats as $seat)
                                        {{$seat}} ,
    ...
    $properties = json_encode([
        ...
        "service" => $fetchScheduleDetails->ferry->service->name,
        "service_id" => $fetchScheduleDetails->ferry->service->id,
        "schedule_id" => $fetchScheduleDetails->id,
        "childrenCountFerry" => $childrenCount,
        "adultCountFerry" => $adultCount,
        "fetchFerryScheduleDetailsID" => $fetchScheduleDetails->id,
        "tripTypeFerry" => $tripType,
        "ferry_trip_id" => $ferry_trip_id,
    ], JSON_THROW_ON_ERROR);
    ?>
    <script>
