...
{{--                                    <a class="dropdown-item" href="#">Third Item</a>--}}
                            ...
                            <p style="font-weight: bold;text-align: center;">{{$checkSchedule[0]->pickup->locations ?? null}}<span style="color: rgb(146,144,144);margin-left: 5px;"></span></p>
                        </div>
...
{{--                                    <a class="dropdown-item" href="#">Third Item</a>--}}
                            ...
                            <p style="font-weight: bold;text-align: left;margin-bottom: 0px;">&nbsp; &nbsp;{{ $departureDate}}</p>
...
{{--                                            <label class="form-label" style="background: var(--bs-orange);border-radius: 6px;">&nbsp;&nbsp;<i class="fa fa-star"></i> A\C&nbsp; &nbsp;</label>--}}
                                        ...
                                        <div class="col" >
                                            ...
                                            <p class="text-start" style="font-size: 17px;"><span>&nbsp;
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-clock-fill">
                                        ...
                                        <div class="col">
                                            ...
                                            <p class="text-start" style="font-size: 17px;"><span>  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-clock-fill">
                                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"></path>&nbsp;</span>
                                                <span>{{$schedule->event_date->format('Y F d')}}</span></p>
                                        </div>
                                        <div class="col text-center">
                                            <p class="text-center">Adult&nbsp;&nbsp;<span style="color: rgb(52,63,95);"><strong>&#x20A6; {{number_format($schedule->amount_adult)}}</strong></span>&nbsp;</p>
