...
@section('content')
    ...
    <div class="container">
        ...
        <div class="plan_container">
            ...
            @for($i =0,$iMax = count($car->plans) ; $i < $iMax ; $i++)
                <div class="plan_box">
                    ...
                    <div class="plan_description">
                        @if ($car->plans[$i]->plan == "Daily Rentals")
                            <h6>Vehicle only available
                                within {{ Ucfirst($car->state?$car->state->location:"Not available") }} </h6>
                            <small>*Extra Hour Charges apply over rental period, driver's accomodation must be
                                provided</small>
                        @else
